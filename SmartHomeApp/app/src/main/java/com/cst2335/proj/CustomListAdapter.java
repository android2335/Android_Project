...
public class CustomListAdapter extends ArrayAdapter<String> {
    ...
    public CustomListAdapter(Activity context, ArrayList<String> itemname, ArrayList<Integer> imgid) {
        super(context, R.layout.kitchenlist, itemname);
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.kitchenlist, null,true);
...
/*        deleteButton.setOnClickListener(new View.OnClickListener(){
        ...
        extratxt.setText("No." + Integer.toString(position+1));
        return rowView;
